...
```sh
codesign --verify --deep --strict --verbose=2 "dist/mac-universal/OrganAIsation.app"
spctl --assess --type execute --verbose "dist/mac-universal/OrganAIsation.app"   # → "accepted, source=Notarized Developer ID"
xcrun stapler validate "dist/mac-universal/OrganAIsation.app"
```
